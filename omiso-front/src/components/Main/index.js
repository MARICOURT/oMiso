  ...
  <div className="container" id="accueil">
    ...
    <div className="row ">
      <div className="col text-center">
        ...
        <p className="para"> O'miso est heureux de vous accueillir depuis plus de cinq ans afin de vous faire découvrir notre savoir faire, que nous avons développé tout au long de nos voyages en Asie. Tous nos produits sont sélectionnés avec soin afin de vous faire voyager grâce à notre cuisine.
        </p>
        <p className="para">
